...
pygtk.require('2.0')
import gtk, gtk.glade, time, sqlobject, os #@UnusedImport @UnresolvedImport
try:
    import geninformes
except ImportError:
    import sys
...
class PendientesRecibir(Ventana):
    ...
    def __init__(self, objeto = None, usuario = None):
        ...
        """
        from tempfile import gettempdir #@UnresolvedImport
        import datetime
        ...
        import informes
        informes.abrir_pdf(geninformes.pendiente_recibir(exportar_a_csv_a = ruta_csv))
