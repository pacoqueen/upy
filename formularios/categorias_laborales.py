...
class CategoriasLaborales(Ventana):
    def __init__(self, objeto = None, usuario = None):
        ...
        connections = {'b_salir/clicked': self.salir,
                       'b_nuevo/clicked': self.crear_nueva_categoria_laboral,
    ...
    def es_diferente(self):
        ...
        for col in categoria_laboral.sqlmeta.columns:
            if col not in ("codigo", "puesto", "daClases"):
                continue
...
#                self.logger.error(txt)
    ...
    def crear_nueva_categoria_laboral(self, widget):
        """
        ...
        if categoria_laboral!=None:
            categoria_laboral.notificador.set_func(lambda : None)
        categoria_laboral = pclases.CategoriaLaboral(codigo = '', puesto = '',
                                                     daClases = True)
