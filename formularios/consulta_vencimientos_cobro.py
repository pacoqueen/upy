...
class ConsultaVencimientosCobros(Ventana):
    ...
    def __init__(self, objeto = None, usuario = None):
        ...
        self.inicio = datetime.date(day = 1, month = datetime.date.today().month, year = datetime.date.today().year)
    ...
    def colorear(self, tv):
        def cell_func(col, cell, model, itr):
            ...
            fecha = datetime.date(day = int(d), month = int(m), year = int(a))
    ...
    def cumple_requisitos(self, tuplalogic, fechaini, fechafin):
        ...
        return fechavto != None and fechavto >= fechaini and fechavto <= fechafin and tuplalogic.cobros == []
        ...
        if fechavto != []:      # Fecha vencimiento viene completa
            ...
            if fechavto != []:       # Sólo tengo día y mes de vencimiento.
                ...
                if fechafra != []:  # Si la encuentro:
                    ...
                    res = datetime.date(day = int(dia), month = int(mes), year = int(anno))
        return res
