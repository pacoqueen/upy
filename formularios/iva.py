...
class IVA(Ventana):
    ...
    def __init__(self, objeto = None, usuario = None):
        ...
        self.wids['e_fecha_fin'].set_text(utils.str_fecha(datetime.date.today()))
        gtk.main()
    ...
    def aplicar_trimestre(self, boton):
        ...
        if self.wids['rd1t'].get_active():
            fini = datetime.date(day = 1, month = 1, year = anno)
            ffin = datetime.date(day = 31, month = 3, year = anno)
        elif self.wids['rd2t'].get_active():
            fini = datetime.date(day = 1, month = 4, year = anno)
            ffin = datetime.date(day = 30, month = 6, year = anno)
        elif self.wids['rd3t'].get_active():
            fini = datetime.date(day = 1, month = 7, year = anno)
            ffin = datetime.date(day = 30, month = 9, year = anno)
        elif self.wids['rd4t'].get_active():
            fini = datetime.date(day = 1, month = 10, year = anno)
            ffin = datetime.date(day = 31, month = 12, year = anno)
        else:
            fini = datetime.date(day = 1, month = 1, year = anno)
            ffin = datetime.date(day = 31, month = 12, year = anno)
