...
class ConsultaAlbaranesPorFacturar(Ventana):
    ...
    def rellenar_tabla(self, items, comisiones, transportes):
        ...
        self.wids['e_total_salida'].set_text("%d " % total_salida)
        self.wids['e_total_entrada'].set_text("%d " % total_entrada)
    ...
    def imprimir(self,boton):
        ...
        abrir_pdf(treeview2pdf(self.wids['tv_entrada'], 
            ...
            fecha = fechaInforme, 
            extra_data = [["", "", 
                           "Albaranes de entrada sin facturar:", 
                           self.wids['e_total_entrada'].get_text()], 
                          ["", "", 
                           "Valor entradas sin facturar:", 
                           self.wids['e_euros_entrada'].get_text()]
                         ]
            ))
        abrir_pdf(treeview2pdf(self.wids['tv_salida'], 
            ...
            fecha = fechaInforme, 
            extra_data = (("", "", 
                           "Albaranes de salida sin facturar:", 
                           self.wids['e_total_salida'].get_text()), 
                          ("", "", 
                           "Valor entradas sin facturar:", 
                           self.wids['e_euros_salida'].get_text())
                         )
            ))
